...
const BackToTop = () => {
    ...
    return (
        <div className="fixed bottom-8 right-8 z-50 flex flex-col items-center gap-4">
            ...
            >
                {/* Tooltip */}
                <span className="absolute right-full mr-3 bg-white/10 backdrop-blur-md border border-white/20 text-white px-3 py-1 rounded-lg text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                    Join Community
                </span>
